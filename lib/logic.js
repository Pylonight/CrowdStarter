...
function pledge(pledge) {
    ...
    console.log('#### backer '+backer.email+' balance before: '+backer.balance);
    backer.balance -= value;
    console.log('#### backer '+backer.email+' balance after: '+backer.balance);
    ...
    // update backer info
    if (backer.pledges == null) {
        backer.pledges = [];
    }
    backer.pledges.push(pledge);

    // update project info
    if (project.pledges == null) {
        project.pledges = [];
    }
